...
public class ZoneTrigger {
   ...
   */
  @Getter @Setter private NetworkTable triggerTable;
   ...
   */
  private List<Pair<Translation2d, Translation2d>> ifShouldFlip(
            ...
            updatedZones.add(
                Pair.of(
                    ...
                    AllianceFlipUtil.apply(
                        pair.getFirst()))); // Flip corners as well. First becomes second.
          });
      return updatedZones;
    } else {
      // Else, don't.
