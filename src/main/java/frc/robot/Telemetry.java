...
public class Telemetry {
  ...
  public static final NetworkTable telemetryTable =
      NetworkTableInstance.getDefault().getTable(telemetryPath);
  ...
  Telemetry() {
    ...
    if (RobotBase.isSimulation()) {
      ((Arena2026Rebuilt) SimulatedArena.getInstance())
          .setEfficiencyMode(true); // Spawn more or less.
