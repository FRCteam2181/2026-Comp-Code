...
public class LaunchCalculator {
  ...
  private final LinearFilter turretAngleFilter =
      LinearFilter.movingAverage((int) (0.1 / GenericConstants.loopPeriodSecs));
  ...
  public LaunchingParameters getParameters() {
    ...
    turretVelocity =
        turretAngleFilter.calculate(
            turretAngle.minus(lastTurretAngle).getRadians() / GenericConstants.loopPeriodSecs);
    hoodVelocity =
        hoodAngleFilter.calculate((hoodAngle - lastHoodAngle) / GenericConstants.loopPeriodSecs);
