...
public class TopIntakeSubsystem extends SubsystemBase {
  ...
  private SmartMotorController topIntakeMotor =
      new SparkWrapper(topIntake, DCMotor.getNEO(1), smcConfig);

  private final FlyWheelConfig topIntakeConfig =
      new FlyWheelConfig(topIntakeMotor)
          ...
          .withTelemetry("Top Intake Roller", Telemetry.telemetryVerbosity.yamsVerbosity);
  ...
  public AngularVelocity gettopVelocity() {
    return topIntakeWheel.getSpeed();
  }
   ...
   */
  public Command settopVelocity(AngularVelocity speed) {
    return topIntakeWheel.setSpeed(speed);
  }
  ...
  public Command set(double dutyCycle) {
    return topIntakeWheel.set(dutyCycle);
  }
