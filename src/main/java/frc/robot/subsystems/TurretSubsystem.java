...
public class TurretSubsystem extends SubsystemBase {
  ...
  private void attemptRotorSeedFromCANCoders() {
    ...
    Angle turretRotations = solvedAngle.get().plus(Angle.ofBaseUnits(.5, Rotations));
  ...
  private EasyCRTConfig buildEasyCrtConfig() {
    ...
    return new EasyCRTConfig(
        ...
        .withAbsoluteEncoderOffsets(Rotations.of(0), Rotations.of(-0.514652))
        // .withAbsoluteEncoderOffsets(Rotations.of(0), Rotations.of(-0.624698))
        .withAbsoluteEncoderInversions(false, false)
        .withMechanismRange(Rotations.of(-0.6), Rotations.of(.6))
