...
public class ShooterAimer extends SubsystemBase {
  ...
  double clearance = Units.inchesToMeters(10); // clearance above goal (or smth idk)
  double velocity;
  double initialVelocity;
  double turretPitchAngle;
  double turretAngle;
  double turretAngleRelative;
  double hubRadius = Units.inchesToMeters(23); // inches
  double hubHeight  = Units.inchesToMeters(72);
  ...
  public ShooterAimer(Transform3d ROBOT_TO_TURRET) {
    ...
    this.ROBOT_TO_TURRET = new Transform3d(
                0, // back from robot center
                0, // centered left/right
                0.451739, // up from the floor reference
                new Rotation3d());
  ...
  public static Distance getDistanceToTarget(Pose2d robot, Translation3d target) {
    ...
    public static ShotData calculateShotFromFunnelClearance(
        ...
        double h = hubHeight + DISTANCE_ABOVE_FUNNEL.in(Inches);
